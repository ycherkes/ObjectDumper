...
### Known restrictions:
- [C#, F# and VisualBasic](https://github.com/ycherkes/ObjectDumper/tree/main/src/ObjectDumper/DebuggeeInteraction/ExpressionProviders) project languages are currently supported only.
