...
This Visual Studio 2022 extension allows you to dump in-memory objects during debugging in the following formats: C# Object Initialization Code, JSON, Visual Basic Object Initialization Code, XML, and YAML.
